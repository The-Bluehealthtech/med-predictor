...
Le rendu intégral s'est révélé trop lent : 50 joueurs en 1 359 secondes, soit environ six heures pour 844 à ce débit. Le processus a été interrompu après ce premier lot. Le lanceur rend maintenant trois joueurs par défaut et donne les marqueurs après chacun ; la couverture 844/844 des colonnes reste fournie par l'audit SQL groupé. Trois rendus ne constituent pas une preuve de rendu sans blanc pour les 844 joueurs.
