...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-gray-600">Track your referee performance and statistics.</p>
                </div>
                <a href="{{ url()->previous() }}" 
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-8">
            <div class="p-6">
                <h2 class="text-xl font-semibold text-gray-900 mb-6">Performance Over Time</h2>
                <div class="h-64 bg-gray-100 rounded-lg flex items-center justify-center">
                    <div class="text-center text-gray-500">
                        ...
                        <p class="mt-1 text-sm text-gray-500">Performance charts will appear here once you have match data.</p>
                    </div>
                </div>
            </div>
        </div>
