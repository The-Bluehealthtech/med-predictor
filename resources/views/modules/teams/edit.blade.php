...
<div class="container-fluid">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="{{ route('modules.teams.update', $team) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="level" 
                        ...
                        <option value="semi-professional" {{ old('level', $team->level) == 'semi-professional' ? 'selected' : '' }}>
                            Semi-Professionnel
                        </option>
                        <option value="amateur" {{ old('level', $team->level) == 'amateur' ? 'selected' : '' }}>
                            Amateur
                        </option>
                        <option value="youth" {{ old('level', $team->level) == 'youth' ? 'selected' : '' }}>
                            Jeunes
                        </option>
                ...
                <div>
                    ...
                    <select id="age_category" 
                        ...
                        <option value="U-17" {{ old('age_category', $team->age_category) == 'U-17' ? 'selected' : '' }}>U-17</option>
                        <option value="U-18" {{ old('age_category', $team->age_category) == 'U-18' ? 'selected' : '' }}>U-18</option>
                        <option value="U-19" {{ old('age_category', $team->age_category) == 'U-19' ? 'selected' : '' }}>U-19</option>
                        <option value="U-20" {{ old('age_category', $team->age_category) == 'U-20' ? 'selected' : '' }}>U-20</option>
                        <option value="U-21" {{ old('age_category', $team->age_category) == 'U-21' ? 'selected' : '' }}>U-21</option>
                        <option value="U-23" {{ old('age_category', $team->age_category) == 'U-23' ? 'selected' : '' }}>U-23</option>
                        <option value="Senior" {{ old('age_category', $team->age_category) == 'Senior' ? 'selected' : '' }}>Senior</option>
                    </select>
                    @error('age_category')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <select id="discipline" 
                        ...
                        <option value="futsal" {{ old('discipline', $team->discipline) == 'futsal' ? 'selected' : '' }}>
                            Futsal
                        </option>
                        <option value="beach_soccer" {{ old('discipline', $team->discipline) == 'beach_soccer' ? 'selected' : '' }}>
                            Beach Soccer
                        </option>
