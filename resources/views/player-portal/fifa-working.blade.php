...
<head>
    ...
    <title>{{ $player->first_name ?? 'Joueur' }} {{ $player->last_name ?? '' }} - FIFA Ultimate Dashboard</title>
                ...
                <div class="flex flex-col lg:flex-row items-center justify-between space-y-6 lg:space-y-0">
                        ...
                        <div class="relative flex-shrink-0">
                            <div class="w-32 h-32 lg:w-36 lg:h-36 rounded-full overflow-hidden border-4 border-white/20 shadow-2xl bg-gradient-to-br from-gray-400 to-gray-600">
                                ...
                                <img src="https://cdn.futbin.com/content/fifa23/img/players/158023.png" 
                                     ...
                                     onerror="this.onerror=null; this.src='https://www.ea.com/fifa/ultimate-team/web-app/content/24B23FDE-7835-41C2-87A2-F453DFDB2E82/2024/fut/items/images/mobile/portraits/158023.png'; if(this.src.includes('ea.com') && this.complete && this.naturalHeight == 0) { this.style.display='none'; this.nextElementSibling.style.display='flex'; }">
                        ...
                        <div class="text-center lg:text-left">
                            ...
                            <div class="flex items-center justify-center lg:justify-start space-x-4 mb-4">
                                ...
                                <div class="flex items-center space-x-2">
                                    <img src="https://logos-world.net/wp-content/uploads/2020/06/Paris-Saint-Germain-PSG-Logo.png" 
                                         alt="Chelsea FC" 
                                         class="w-8 h-8 object-contain"
                                         onerror="this.onerror=null; this.src='data:image/svg+xml;base64,'; if(this.complete && this.naturalHeight == 0) { this.style.display='none'; this.nextElementSibling.style.display='inline-block'; }">
                                    <!-- Fallback club icon -->
                            ...
                            <div class="grid grid-cols-2 lg:grid-cols-4 gap-3 text-sm mb-4">
                                ...
                                <div class="text-center p-2 bg-white/10 rounded-lg">
                                    <div class="font-semibold text-blue-400">170cm</div>
                                    <div class="text-xs opacity-70">Taille</div>
                                </div>
                                <div class="text-center p-2 bg-white/10 rounded-lg">
                                    <div class="font-semibold text-green-400">72kg</div>
                                    <div class="text-xs opacity-70">Poids</div>
                                </div>
                                <div class="text-center p-2 bg-white/10 rounded-lg">
                                    <div class="font-semibold text-purple-400">Gauche</div>
                            ...
                            <div class="grid grid-cols-3 gap-2 text-center text-xs">
                                ...
                                <div class="p-2 bg-white/5 rounded">
                                    <div class="font-bold text-purple-400">28</div>
                    ...
                    <div class="flex flex-col lg:flex-row items-center space-y-4 lg:space-y-0 lg:space-x-6">
                        ...
                        <div class="text-center">
                            ...
                            <div class="text-xs text-white/90">FIFA Ultimate</div>
                        </div>
                        ...
                        <div class="space-y-2 text-sm">
                            <div class="p-3 bg-gradient-to-r from-green-500/20 to-green-600/20 rounded-lg border border-green-500/30">
                                ...
                                <div class="w-full bg-green-900/50 rounded-full h-1 mt-1">
                            ...
                            <div class="grid grid-cols-2 gap-1 text-xs">
                                ...
                                <div class="text-center p-2 bg-white/5 rounded">
                                    <div class="font-bold text-cyan-400">92%</div>
                    ...
                    <div class="performance-card p-6">
                        ...
                        <div class="grid grid-cols-2 gap-3 text-sm">
                            ...
                            <div class="text-center p-2 bg-orange-50 rounded">
                                <div class="font-bold text-orange-600">45%</div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-2">
                                <div class="flex justify-between items-center p-2 bg-green-50 rounded">
                                    ...
                                    <span class="font-bold text-green-600">89g / 85g</span>
                                </div>
                                <div class="flex justify-between items-center p-2 bg-yellow-50 rounded">
                                    <span class="text-sm">🍞 Glucides</span>
                                    <span class="font-bold text-yellow-600">245g / 280g</span>
                                </div>
                                ...
                                <div class="flex justify-between items-center p-2 bg-purple-50 rounded">
                                    ...
                                    <span class="font-bold text-purple-600">2840 / 3200</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="font-bold text-purple-600">1h 45min (21%)</span>
                                </div>
                                <div class="flex justify-between items-center">
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="w-full bg-gray-200 rounded-full h-2">
                                        <div :class="['h-2 rounded-full', 
                                                     injury.recovery_progress >= 90 ? 'bg-green-500' : 
        ...
        createApp({
            data() {
                return {
                    ...
                    notificationData: @php echo json_encode($notificationData ?? [
                        'nationalTeam' => [],
                        'trainingSessions' => [],
                        'matches' => [],
                        'medicalAppointments' => [],
