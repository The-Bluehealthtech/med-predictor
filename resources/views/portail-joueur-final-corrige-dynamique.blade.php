...
<body class="bg-blue-50 text-gray-900 min-h-screen">
    ...
    <script>
        ...
        function updatePerformanceCharts(data) {
            // No per-match or skill history is supplied by this portal endpoint.
            // Never infer a chronology or fill missing measures with zero.
            for (const id of ['performanceChart', 'skillsRadar']) {
