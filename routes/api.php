...
/*
|--------------------------------------------------------------------------
| Google Cloud Storage API Routes
|--------------------------------------------------------------------------
|
| Routes for managing file uploads, downloads, and storage operations
| with Google Cloud Storage integration.
|
*/

Route::prefix('gcs')->middleware(['auth:sanctum'])->group(function () {
    // File upload routes
    Route::post('/upload', [GcsController::class, 'uploadFile']);
    Route::post('/upload-multiple', [GcsController::class, 'uploadFiles']);
    Route::post('/upload-from-url', [GcsController::class, 'uploadFromUrl']);
    
    // File management routes
    Route::get('/files', [GcsController::class, 'listFiles']);
    Route::get('/file-url', [GcsController::class, 'getFileUrl']);
    Route::delete('/file', [GcsController::class, 'deleteFile']);
    
    // Storage management routes
    Route::get('/stats', [GcsController::class, 'getStorageStats']);
    Route::post('/backup', [GcsController::class, 'createBackup']);
    Route::delete('/cleanup-backups', [GcsController::class, 'cleanupOldBackups']);
});
