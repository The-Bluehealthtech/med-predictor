...
$sources = [
    ...
    'player_connected_devices' => ['last_sync_at', ['device_name', 'device_type', 'manufacturer', 'device_model', 'battery_level', 'connection_status', 'sensors_available', 'metadata@api_endpoint']],
    'player_licenses' => ['issue_date', ['club_id', 'license_number', 'status', 'license_type', 'season', 'issuing_authority', 'bonus_structure@training_compensation_test']],
