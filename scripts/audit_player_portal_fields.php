...
$sources = [
    ...
    'player_real_time_health' => ['measurement_time', [
        ...
        'metadata@vitals.heart_rate_recovery', 'metadata@vitals.blood_glucose',
        'metadata@recovery.stretching_minutes',
    ]],
    'player_fitness_logs' => ['log_date', ['energy_level', 'sleep_hours', 'sleep_quality_score', 'muscle_soreness', 'fatigue_level', 'stretching_minutes']],
    ...
    'player_performances' => ['performance_date', ['overall_performance_score', 'physical_score', 'technical_score', 'tactical_score', 'mental_score', 'social_score', 'passing_accuracy', 'shooting_accuracy', 'notes@physical_tests']],
    'performances' => ['match_date', ['tackles_won', 'shots_on_target', 'passes_attempted', 'passes_completed', 'additional_metrics@interceptions']],
    'health_records' => ['record_date', ['risk_score', 'doctor_name', 'medications', 'hematology_results@hemoglobin.value', 'hematology_results@hematocrit.value', 'mineral_results@serum_iron.value', 'vitamin_results@vitamin_d.value', 'inflammatory_markers@crp.value', 'biochemistry_results@total_cholesterol.value']],
